...
class DataStore:
    ...
    def log_hr(self, heartrate: int, rr_intervals: List[float]) -> None:
    ...
    def log_therapy_data(self, heartrate: int, rr_intervals: List[float]) -> None:
    ...
    def save(self) -> Optional[Path]:
        ...
        filename = "session_{}.json".format(timestamp)
